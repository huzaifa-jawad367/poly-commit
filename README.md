...
(e.g. the [vanilla KZG scheme](./poly-commit/src/kzg10/mod.rs) does not implement this trait, but the [Marlin scheme](./src/marlin/mod.rs) which uses it under the hood, does).
